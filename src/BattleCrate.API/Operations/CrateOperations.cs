...
namespace BattleCrate.API.Operations
{
    public class CrateOperations : BaseOperations, ICrateOperations
    {
        ...
        {
            return ApiRequestor.RequestAsync(HttpMethod.Delete, $"crate/{crateUuid}", null, cancellationToken);
        }
        ...
        {
            return ((ICrateOperations)this).DeployCrateAsync<CrateEntity>(configuration, cancellationToken);
        }
        ...
        {
            return ApiRequestor.RequestJsonSerializedAsync<CrateDeployEntity, TCrateEntity>(HttpMethod.Post, "crate/new", configuration, cancellationToken);
        }
        ...
        {
            return ((ICrateOperations)this).EditCrateAsync<CrateEntity>(crateUuid, changes, cancellationToken);
        }
        ...
        public virtual Task<TCrateEntity> EditCrateAsync<TCrateEntity>(Guid crateUuid, CrateEditEntity changes, CancellationToken cancellationToken = default)
            where TCrateEntity : class
        {
            return ApiRequestor.RequestJsonSerializedAsync<CrateEditEntity, TCrateEntity>(HttpMethod.Post, $"crate/{crateUuid}", changes, cancellationToken);
        }
        ...
        {
            return ((ICrateOperations)this).GetCrateAsync<CrateEntity>(crateUuid, cancellationToken);
        }
        ...
        public virtual Task<TCrateEntity> GetCrateAsync<TCrateEntity>(Guid crateUuid, CancellationToken cancellationToken = default)
            where TCrateEntity : class
        {
            return ApiRequestor.RequestJsonSerializedAsync<TCrateEntity>(HttpMethod.Get, $"crate/{crateUuid}", null, cancellationToken);
        }
        ...
        {
            return ((ICrateOperations)this).GetPlayersAsync<CratePlayersEntity>(crateUuid, cancellationToken);
        }
        ...
        {
            return ApiRequestor.RequestJsonSerializedAsync<TCratePlayersEntity>(HttpMethod.Get, $"crate/{crateUuid}/players", cancellationToken);
        }
        ...
        {
            return ((ICrateOperations)this).ListAllCratesAsync<CrateEntity>(cancellationToken);
        }
        ...
        public virtual Task<TCrateEntity[]> ListAllCratesAsync<TCrateEntity>(CancellationToken cancellationToken = default)
            where TCrateEntity : class
        {
            return ApiRequestor.RequestEntireListJsonSerializedAsync<TCrateEntity>("crate", cancellationToken);
        }
        ...
        {
            return ((ICrateOperations)this).ListCratesAsync<CrateEntity>(limit, page, cancellationToken);
        }
        ...
        public virtual Task<ResultResponseEntity<TCrateEntity>> ListCratesAsync<TCrateEntity>(int limit = 25, int page = 1, CancellationToken cancellationToken = default)
            where TCrateEntity : class
        {
            return ApiRequestor.RequestResultResponseJsonSerializedAsync<TCrateEntity>(limit, page, "crate", cancellationToken);
        }
        ...
        {
            return ((ICrateOperations)this).RestartCrateAsync<OperationEntity>(crateUuid, TimeSpan.FromMinutes(2), cancellationToken);
        }
        ...
        {
            return ((ICrateOperations)this).RestartCrateAsync<TOperationEntity>(crateUuid, TimeSpan.FromMinutes(2), cancellationToken);
        }
        ...
        {
            return ((ICrateOperations)this).RestartCrateAsync<OperationEntity>(crateUuid, timeout, cancellationToken);
        }
        ...
        public virtual Task<TOperationEntity> RestartCrateAsync<TOperationEntity>(Guid crateUuid, TimeSpan timeout, CancellationToken cancellationToken = default)
            where TOperationEntity : class
        {
            return RequestWithTimeoutAsync<TOperationEntity>(timeout, $"crate/{crateUuid}/restart", cancellationToken);
        }
        ...
        {
            return ApiRequestor.RequestAsync(HttpMethod.Post, $"crate/{crateUuid}/console", command, cancellationToken);
        }
        ...
        {
            return ((ICrateOperations)this).StartCrateAsync<OperationEntity>(crateUuid, TimeSpan.FromMinutes(2), cancellationToken);
        }
        ...
        public virtual Task<TOperationEntity> StartCrateAsync<TOperationEntity>(Guid crateUuid, CancellationToken cancellationToken = default)
            where TOperationEntity : class
        {
            return ((ICrateOperations)this).StartCrateAsync<TOperationEntity>(crateUuid, TimeSpan.FromMinutes(2), cancellationToken);
        }
        ...
        {
            return ((ICrateOperations)this).StartCrateAsync<OperationEntity>(crateUuid, timeout, cancellationToken);
        }
        ...
        public virtual Task<TOperationEntity> StartCrateAsync<TOperationEntity>(Guid crateUuid, TimeSpan timeout, CancellationToken cancellationToken = default)
            where TOperationEntity : class
        {
            return RequestWithTimeoutAsync<TOperationEntity>(timeout, $"crate/{crateUuid}/start", cancellationToken);
        }
        ...
        {
            return ((ICrateOperations)this).StopCrateAsync<OperationEntity>(crateUuid, TimeSpan.FromMinutes(2), cancellationToken);
        }
        ...
        public virtual Task<TOperationEntity> StopCrateAsync<TOperationEntity>(Guid crateUuid, CancellationToken cancellationToken = default)
            where TOperationEntity : class
        {
            return ((ICrateOperations)this).StopCrateAsync<TOperationEntity>(crateUuid, TimeSpan.FromMinutes(2), cancellationToken);
        }
        ...
        {
            return ((ICrateOperations)this).StopCrateAsync<OperationEntity>(crateUuid, timeout, cancellationToken);
        }
        ...
        public virtual Task<TOperationEntity> StopCrateAsync<TOperationEntity>(Guid crateUuid, TimeSpan timeout, CancellationToken cancellationToken = default)
            where TOperationEntity : class
        {
            return RequestWithTimeoutAsync<TOperationEntity>(timeout, $"crate/{crateUuid}/stop", cancellationToken);
        }
        #endregion
